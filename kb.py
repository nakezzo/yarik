...
def ref():
    kb = InlineKeyboardMarkup(row_width=2)
    kb.add(InlineKeyboardButton("⚡️ Рефералы", callback_data='refs'),InlineKeyboardButton("⚡️ Вывести", callback_data='ref_pay'))
    kb.add(InlineKeyboardButton("◀️ Назад", callback_data='profile'))
    return kb

def cashback():
    kb = InlineKeyboardMarkup(row_width=1)
    kb.add(InlineKeyboardButton("⚡️ Вывести", callback_data='cb_pay'))
    kb.add(InlineKeyboardButton("◀️ Назад", callback_data='profile'))
    return kb
...
def admin():
    ...
    btn7 = InlineKeyboardButton("⚡️ Упр. Чеками", callback_data='check')
